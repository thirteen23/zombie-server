...
CREATE TABLE web.movements (
  ...
  origin_start TIMESTAMP WITH TIME ZONE NOT NULL CHECK (origin_start < origin_end),
  origin_end TIMESTAMP WITH TIME ZONE NOT NULL CHECK (origin_end > origin_start),
